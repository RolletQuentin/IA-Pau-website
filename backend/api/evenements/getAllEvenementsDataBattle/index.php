<?php
// Exemple utilisation : http://localhost/api/evenements/getAllEvenementsDataBattle/
// Headers requis
...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    $stmt = $evenement->getAllEvenementsDataBattle();

    // On vérifie si on a au moins 1 produit
    if($stmt->rowCount() > 0){
        // On initialise un tableau associatif
        $tableauEvenements = [];
        $tableauEvenements['Evenements DataBattle'] = [];
        ...
        while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
            ...
            $tableauEvenements['Evenements DataBattle'][] = $prod;
        }
