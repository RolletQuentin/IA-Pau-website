...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
 ...
 <body class="font">
    ...
    <div class="content">
            ...
            <?php
                ...
                foreach($products as $product){
                    ...
                    if($isAldReadyPrinted == false && $needToPrint == true){
                        ...
                        if($_SESSION['Statut-Connexion'] == true && $_SESSION['login'] == "Root"){
                ...
                if($cAffiche == 0){
                    echo "<br><br>";
                    echo "<img src='assets/Images/noCat.jpeg'>";
        ...
        <?php
            if($_SESSION['Statut-Connexion'] == true && $_SESSION['login'] == "Root"){
                echo "<button id=\"hiderbutton\" class=\"hiderButton\" onclick=\"setVisibility()\">Cacher les stocks</button>";
            }
        ?>
    </div>
    <footer class="footer">
